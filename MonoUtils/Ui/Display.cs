...
public class Display
{
    ...
    public static float CustomWidth { get; set; } = Width;
    public static float CustomHeight { get; set; } = Height;

    public static Vector2 Size => new Vector2(CustomWidth, CustomHeight);
